...
var Module = typeof ExampleModule != 'undefined' ? ExampleModule : {};
...
["_main","__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_tls_init","_pthread_self","executeNotifiedProxyingQueue","establishStackSpace","invokeEntryPoint","PThread","_CreateFreeQueue","_DestroyFreeQueue","_FreeQueuePush","_FreeQueuePull","_GetFreeQueuePointerByMember","_PrintQueueInfo","_PrintQueueAddresses","_getFreeQueue","_audio_loop","_fflush","__emscripten_proxy_execute_task_queue","onRuntimeInitialized"].forEach((prop) => {
...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'build/example.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/example.data');
    ...
    loadPackage({"files": [{"filename": "/moonlight.mp3", "start": 0, "end": 15786016, "audio": 1}], "remote_package_size": 15786016});
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('example.wasm', import.meta.url).toString();
}
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},init:function() {
        ...
        if (!Module['locateFile']) {
          PThread.unusedWorkers.push(new Worker(new URL('example.worker.js', import.meta.url)));
          return;
        }
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,___syscall_fcntl64,___syscall_ioctl,___syscall_openat,_fd_close,_fd_read,_fd_seek,_fd_write];
...
/** @type {function(...*):?} */
var _GetFreeQueuePointerByMember = Module["_GetFreeQueuePointerByMember"] = createExportWrapper("GetFreeQueuePointerByMember");
...
/** @type {function(...*):?} */
var _audio_loop = Module["_audio_loop"] = createExportWrapper("audio_loop");
